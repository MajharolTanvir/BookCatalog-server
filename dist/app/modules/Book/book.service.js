...
const updateBook = (id, updatedData, user) => __awaiter(void 0, void 0, void 0, function* () {
    const availableBook = yield book_model_1.Book.findOne({ _id: id });
    if (availableBook && (user === null || user === void 0 ? void 0 : user.userEmail) !== (availableBook === null || availableBook === void 0 ? void 0 : availableBook.addedBy)) {
