...
const signUpUser = (userData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = jwtHelper_1.JwtHelper.createToken({ userEmail }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
    return {
        createdUser,
        accessToken,
    };
...
const loginUser = (userData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = jwtHelper_1.JwtHelper.createToken({ userEmail }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
    const refreshToken = jwtHelper_1.JwtHelper.createToken({ userEmail }, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expire_in);
    return {
        accessToken,
        refreshToken,
    };
});
const addWishlist = (email, wishlist, user) => __awaiter(void 0, void 0, void 0, function* () {
    if ((user === null || user === void 0 ? void 0 : user.userEmail) !== email) {
        throw new ApiError_1.default(http_status_1.default.FORBIDDEN, "Forbidden access");
    }
    const updatedUser = yield user_model_1.User.findOneAndUpdate({ email }, { $addToSet: { bookStatus: wishlist === null || wishlist === void 0 ? void 0 : wishlist.bookStatus } }, { new: true });
    return updatedUser;
});
exports.UserService = {
    signUpUser,
